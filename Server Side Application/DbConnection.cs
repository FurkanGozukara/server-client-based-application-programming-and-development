...
{ 
    public static string srConnectionString = "server=localhost;database=SimpleGame; integrated security=SSPI;persist security info=False; Trusted_Connection=Yes; ";
